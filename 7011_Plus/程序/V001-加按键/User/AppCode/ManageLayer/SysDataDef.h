...
#define DpSwitchF      (SysPara & Bit8)     // 上报Dp按键值标志
#define SetDpSwitchF    SysPara |= Bit8
#define ClrDpSwitchF    SysPara &= CBit8

#define DpBrightF      (SysPara & Bit9)     // 上报灯亮度值标志
...
#define SecondGearF      (SysPara & Bit13)
#define SetSecondGearF    SysPara |= Bit13
#define ClrSecondGearF    SysPara &= CBit13

#define ThirdGearF      (SysPara & Bit14)
#define SetThirdGearF    SysPara |= Bit14
#define ClrThirdGearF    SysPara &= CBit14

//#define GearF      (SysPara & Bit15)
//#define SetThirdGearF    SysPara |= Bit15
//#define ClrThirdGearF    SysPara &= CBit15
