...
//#endif            
        ...
        case 0x12:
            ...
            Dimmer.FaceValue = LightValTab[Dimmer.MinLightVal][temp_value - 1];
...
void ModeKeyProc(void)
{
    ...
    switch(Dimmer.MinLightVal)
    {
        case 0:
            ...
            if((FirstGearP != 0) && (SecondGearP == 0 || ThirdGearP == 0))
            {
                SetDimmerKeyF;
                SetDpBrightF;
                temp_min = LedShowTrans(Dimmer.FaceValue);
                
                if(SecondGearP == 0)
                    Dimmer.MinLightVal = 1;
                else
                    Dimmer.MinLightVal = 2;
                
                Dimmer.FaceValue = LightValTab[Dimmer.MinLightVal][temp_min - 1]; 
            }
            break;
        ...
        case 1:
            ...
            if((SecondGearP != 0) && (FirstGearP == 0 || ThirdGearP == 0))
            {
                SetDimmerKeyF;
                SetDpBrightF;
                temp_min = LedShowTrans(Dimmer.FaceValue);
        ...
        case 2:
            ...
            if((ThirdGearP != 0) && (FirstGearP == 0 || SecondGearP == 0))
            {
                SetDimmerKeyF;
                SetDpBrightF;
                temp_min = LedShowTrans(Dimmer.FaceValue);
