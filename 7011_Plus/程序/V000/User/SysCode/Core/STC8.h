...
#define MCKSEL      (*(unsigned char volatile xdata *)0xfe00)   //时钟选择寄存器
...
//看门狗扩展
#define WDT_TIME_1	0x23
#define WDT_TIME_2  0x24
#define WDT_TIME_3  0x27
...
#ifndef	Hiht_Level
#define				Hiht_Level						1	// 拉高
#endif

#ifndef	Low_Level
#define				Low_Level							0	// 拉低
#endif


typedef enum
{
	EXECUTE_ERROR_OK			 =	0,		// Everything executed normally // 成功
	EXECUTE_ERROR_NULL		 =	1,		//	空操作
	EXECUTE_ERROR_FAILURE  = 	2,		//	失败
	EXECUTE_ERROR_LAST
}Execute_e;
