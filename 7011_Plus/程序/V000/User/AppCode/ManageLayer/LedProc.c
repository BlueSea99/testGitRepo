...
UI08 LedShowTrans(UI16 Value)
{
    ...
    if(Value < LightValTab[0])
    {
        show_value = 0;
    }
    else if(Value >= LightValTab[0] && Value < LightValTab[1])
    {
        show_value = 1;
    }
    else if(Value >= LightValTab[1] && Value < LightValTab[2])
    {
        show_value = 2;
    }
    else if(Value >= LightValTab[2] && Value < LightValTab[3])
    {
        show_value = 3;
    }
    else if(Value >= LightValTab[3] && Value < LightValTab[4])
    {
        show_value = 4;
    } 
    else if(Value >= LightValTab[4] && Value < LightValTab[5])
    {
        show_value = 5;
    }
    else if(Value >= LightValTab[5] && Value < LightValTab[6])
    {
        show_value = 6;
    }
    else if(Value >= LightValTab[6] && Value < LightValTab[7])
    {
        show_value = 7;
    }
    else if(Value >= LightValTab[7] && Value < LightValTab[8])
    {
        show_value = 8;
    } 
    else if(Value >= LightValTab[8] && (Value < LightValTab[8] + 22))
    {
        show_value = 9;
    }
    else if((Value >= LightValTab[8] + 22))
    {
        show_value = 10;
    }
