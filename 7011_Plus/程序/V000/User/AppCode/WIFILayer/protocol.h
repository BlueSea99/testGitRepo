...
/******************************************************************************
                            1:修改产品信息                
******************************************************************************/
#define PRODUCT_KEY "zGnSbZFOqo0qCHHs"    //开发平台创建产品后生成的16位字符产品唯一标识 KS-7011
//#define PRODUCT_KEY "ABeGCbVNqpMZCEtm"      //开发平台创建产品后生成的16位字符产品唯一标识 BAZZ
